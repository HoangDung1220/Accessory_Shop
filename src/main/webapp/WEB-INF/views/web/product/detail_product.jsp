...
<div class="well well-small">
	<ul class="nav nav-list">
		 <c:forEach var="item" items="${listCategory}">
	    		<li><a href='<c:url value="/san-pham/${item.id }/${1}/${8}" />'><span class="icon-circle-blank"></span> ${item.name}</a></li>
	    </c:forEach>
...
<div class="span9">
	...
	<div class="row-fluid">
			...
			<div id="myCarousel" class="carousel slide cntr">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="#"> <img width="1000" src='<c:url value="/template/web/img/${product.img}" />' alt="" ></a>
                  </div>
                  <div class="item">
			...
			<c:set var ="count" value="${productsRelatve.size()}"/>
			<c:if test="${count>5}">
			<c:set var ="count" value="5"/>
			</c:if>
			
			<c:forEach var ="item" items ="${productsRelatve}" begin="1" end ="${count }" varStatus="loop">
		  <div class="row-fluid"> 
			<div class="span2">
				<img src='<c:url value="/template/web/img/${item.img}" />' alt="">
			</div>
			<div class="span6">
				<h5>${item.name } </h5>
				<p>
			...
			<div class="btn-group">
			  <a href='<c:url value="/addcart/${item.id }" />' class="defaultBtn"><span class=" icon-shopping-cart"></span> Add to cart</a>
